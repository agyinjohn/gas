...
function getReactRoot() {
  ...
  throw new Error(
    'React 19 not found for mobile. Run: npm install react@19.1.0 -w @getgas/rider-mobile'
  );
}
...
if (!metroRuntimeVersion.startsWith('6.')) {
  throw new Error(
    `@expo/metro-runtime@${metroRuntimeVersion} resolved — need 6.x. Run: npm install @expo/metro-runtime@6.1.2 -w @getgas/rider-mobile`
  );
}
