...
export type OrderType = 'delivery' | 'exchange' | 'fill';
...
export type UserRole = 'user' | 'rider' | 'station' | 'admin';
...
export interface Order {
  ...
  pickupAddress?: { street: string; city: string; lat: number; lng: number };
